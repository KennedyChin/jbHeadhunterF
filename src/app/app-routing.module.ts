...
const routes: Routes = [
  ...
  // 職缺
  {
    path: routesPath.job.path, component: JobsMainComponent, children: [
  ...
  // 收藏職缺
  {
    path: routesPath.savedjobs.path, component: JobsSavedComponent
  },
  {
    path:"MyAddr",component:WhereUareComponent
  }
